...
- **Execution** — `lib/commodus/autotrader/execute.ts` reuses `validatePolicy`, `reserveOrLoadExecution`, Privy swap, decode, fee transfer, lots, and the season ledger path (same path as human players).
